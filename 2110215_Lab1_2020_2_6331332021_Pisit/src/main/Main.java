...
public class Main {
	...
	public static void removeDepartmentFromDatabase(int index) {
		...
		ArrayList<GuildMember> allMembersList = new ArrayList<>();
		allMembersList = myDatabase.removeDepartment(index);
		getUnassignedDepartment().addMultipleMembers(allMembersList);
		System.out.println("Department removed. "+allMembersList.size()+" member(s) added to Unassigned Department.");
	}
